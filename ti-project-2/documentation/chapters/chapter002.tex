...
\textbf{Kalkulator liczb - arabskie/rzymskie:} Kalkulator przeliczający wpisane liczby arabskie na ich rzymski odpowiednik, prezentujący wynik w czasie rzeczywistym.

\textbf{Obsługa formularza kontaktowego:} Sekcja z walidacją pól (imię, email, treść wiadomości). Skrypt sprawdza poprawność danych i informuje użytkownika o błędach lub powodzeniu wysłania wiadomości za pomocą autorskich komunikatów - \textit{custom alerts}.
...
\textbf{Technologie:} Strona zgodnie z przyjętymi wytycznymi skupiać powinna się na wykorzystaniu skryptów w języku \textbf{JavaScript}. Dozwolone jest natomiast wykorzystanie ich w formie strony internetowej, gdzie wykorzystane będą również inne technologie.
