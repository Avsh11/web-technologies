...
Rozwiązanie problemu przebiegnie w kilku zdefiniowanych korkach. W pierwszej kolejności nastąpi zaprojektowanie schematu każdej ze stron czyt. układ treści i nawigacji. Kolejnym krokiem będzie postawienie szkieletu strony przy pomocy technologii \texttt{HTML5} zaś krokiem kolejnym będzie stopniowe wdrażanie stylów przy użyciu technologii kaskadowych arkuszy stylów. Końcowym i zarazem najważniejszym krokiem będzie optymalizacja responsywności strony na urządzenia mobilne takie jak smartfon bądź tablet poprzez Media Queries.

\section{Wymagania funkcjonalne}
Poniższe wymagania opisują, jakie operacje i interakcje umożliwia strona internetowa użytkownikowi końcowemu:\newline\newline
\textbf{Nawigacja po sekcjach:} Strona musi umożliwiać użytkownikowi płynne przechodzenie po konkretnych sekcjach strony (Home, Our Story, Services, Jobs, Contact) po kliknięciu w odowiedni załącznik prowadzących do wspomnianych sekcji.\newline\newline
...
\textbf{Animacja powitalna:} Podczas załadowania strony głównej, strona autmatycznie ma odtworzyć prostą animację powitalną, aby przykuć uwagę użytkownika.\newline\newline
...
\textbf{Estetyka i spójność wizualna:} Strona musi utrzymywać spójność kolorystyczną, wykorzustując spójną typografię w zależności od sekcji.\newline\newline
...
\textbf{Kompatybilność:} Witryna powinna wyświetlać się poprawnie zrówno na przeglądarkach wyposażonych w silnik \texttt{Chromium} jak i \texttt{Gecko}.\newline\newline
