...
% 1. DEFINICJA JĘZYKA (Słownik dla LaTeXa)
\lstdefinelanguage{JavaScript}{
  keywords={break, case, catch, continue, debugger, default, delete, do, else, false, finally, for, function, if, in, instanceof, new, null, return, switch, this, throw, true, try, typeof, var, void, while, with, let, const, async, await, document, window, console, classList, toggle},
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
  morestring=[b]",
...
% 2. DEFINICJA STYLU (Wygląd edytora)
...
\lstdefinestyle{styleEditorJS}{
    ...
    belowskip=15pt,
    captionpos=t,
    % Obsługa polskich znaków wewnątrz stylu
...
\titlePL{Technologie Internetowe - JavaScript}

\shorttitlePL{Technologie Internetowe - JavaScript} % skrócona wersja tytułu jeśli jest bardzo długi
